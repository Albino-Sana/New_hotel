...
<script>
    ...
    function carregarDadosFaturamento(periodo = '7dias') {
        ...
        fetch(`/sys/hotelaria/relatorios/dados-faturamento?periodo=${periodo}`)
            ...
            .then(data => {
                ...
                var gradientStroke = ctxFaturamento.createLinearGradient(0, 230, 0, 50);
    ...
    document.querySelectorAll('.periodo-btn').forEach(btn => {
        btn.addEventListener('click', function () {
            ...
            carregarDadosFaturamento(this.dataset.periodo);
        });
    });
