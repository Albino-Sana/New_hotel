...
<body class="g-sidenav-show bg-gray-100">
                ...
                <div class="col-lg-12 mb-lg-0 mb-4">
                    <div class="card z-index-2 h-100">
                        <div class="card-header pb-0 pt-3 bg-transparent d-flex justify-content-between align-items-center">
                            <div>
                                <h6 class="text-capitalize" id="grafico-titulo">Faturamento no Período</h6>
                        ...
                        <div class="card-body p-3">
                            <div class="chart">
                                <canvas id="faturamentoChart" class="chart-canvas" height="300"></canvas>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    @include('relatorios.grafico_faturamento')
