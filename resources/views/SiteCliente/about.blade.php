                            ...
                            <div class="navbar-nav mr-auto py-0">
                                ...
                                <div class="nav-item dropdown">
                                    ...
                                    <div class="dropdown-menu rounded-0 m-0">
                                        ...
                                        <a href="testimonial.html" class="dropdown-item">Testemunha</a>
                                    </div>
                                </div>
                ...
                <div class="container text-center pb-5">
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb justify-content-center text-uppercase">
                            ...
                            <li class="breadcrumb-item"><a href="#">Piginas</a></li>
        ...
        <div class="container-xxl py-5">
            <div class="container">
                <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                    <h6 class="section-title text-center text-primary text-uppercase">Nossa Equipa</h6>
                    <h1 class="mb-5">Explore Nossa<span class="text-primary text-uppercase">Equipa</span></h1>
                </div>
                <div class="row g-4">
                ...
                <div class="col-lg-10 border rounded p-1">
                    <div class="border rounded text-center p-1">
                        <div class="bg-white rounded text-center p-5">
                            <h4 class="mb-4">Inscrive-se no nosso <span class="text-primary text-uppercase">Boletin informativo</span></h4>
                    ...
                    <div class="col-lg-5 col-md-12">
                        <div class="row gy-5 g-4">
                            ...
                            <div class="col-md-6">
                                ...
                                <a class="btn btn-link" href="">Comida e Restaurante</a>
                                <a class="btn btn-link" href="">Spa & Fitness</a>
                                <a class="btn btn-link" href="">Esportes e jogos</a>
                                <a class="btn btn-link" href="">Evento e Festas</a>
                                <a class="btn btn-link" href="">GINÁSTICA e IOGA</a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="copyright">
                    <div class="row">
                        <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                            &copy; <a class="border-bottom" href="#">Nome do seu site</a>, Todos os direitos reservados.

                            <!--/*** This template is free as long as you keep the footer author’s credit link/attribution link/backlink. If you'd like to use the template without the footer author’s credit link/attribution link/backlink, you can purchase the Credit Removal License from "https://htmlcodex.com/credit-removal". Thank you for your support. ***/-->
                            Projetado por <a class="border-bottom" href="https://htmlcodex.com">HTML Codex</a>
                        </div>
