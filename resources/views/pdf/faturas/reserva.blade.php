...
<head>
    <meta charset="UTF-8">
    <title>Fatura - Reserva #{{ $fatura->numero }}</title>
    <style>
        @page {
            size: A4;
            margin: 1.5cm;
    ...
    <div class="container">
        <div class="header">
            ...
            <div class="invoice-info">
                <div class="invoice-title">FATURA DE RESERVA</div>
                <div class="invoice-number">Documento #{{ $fatura->numero }}</div>
        ...
        <div class="client-info">
            ...
            <div><strong>Nome:</strong> {{ $reserva->cliente_nome ?? $fatura->nome_cliente }}</div>
        ...
        <table class="details-table">
            ...
            <tbody>
                <tr>
                    <td>Reserva</td>
                    <td>
                        Quarto {{ optional(optional($reserva)->quarto)->numero ?? 'N/D' }} -
                        {{ optional(optional(optional($reserva)->quarto)->tipo)->nome ?? 'N/D' }} |
                        {{ optional($reserva)->data_entrada ? \Carbon\Carbon::parse($reserva->data_entrada)->format('d/m/Y') : 'N/D' }}
                        a
                        {{ optional($reserva)->data_saida ? \Carbon\Carbon::parse($reserva->data_saida)->format('d/m/Y') : 'N/D' }}
                    </td>
