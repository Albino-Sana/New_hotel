...
return new class extends Migration
{
    ...
    {
Schema::create('fatura_recibos', function (Blueprint $table) {
    $table->id();
    $table->string('tipo_documento')->default('Fatura-Recibo');
    ...
    $table->string('estado_documento')->default('Emitido');
    ...
    {
        Schema::dropIfExists('fatura_recibos');
    }
};
